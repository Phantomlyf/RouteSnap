...
public class GpsConverter {
    ...
    /**
     * * 火星坐标系 (GCJ-02) to WSG84 * *
     * @param lon *
     * @param lat *
     * @return
     * */
    public  double[] gcj02_To_Gps84(double lat, double lon) {
     ...
     * @return
     */
    public  double[] gps84_To_bd09(double lat, double lon) {
        double[] gcj02 = gps84_To_Gcj02(lat, lon);
        double[] bd09 = gcj02_To_Bd09(gcj02[0], gcj02[1]);
        return bd09;
    }

    public  double[] bd09_To_gps84(double lat, double lon) {
     ...
     * @return
     */
    public   double retain6(double num) {
